...
class View extends __WEBPACK_IMPORTED_MODULE_0__helpers__["c" /* EventEmitter */] {
  ...
  createListItem(todo) {
    ...
    const editInput = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers__["d" /* createElement */])('input', { type: 'text', className: 'text_field' });
    const editButton = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers__["d" /* createElement */])('button', { className: 'edit' }, 'Edit');
    const deleteButton = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers__["d" /* createElement */])('button', { className: 'remove' }, 'Remove');
  ...
  handleAdd(event) {
    ...
    if (!this.input.value) return alert('You must enter a task name.');
  ...
  handleEdit({ target }) {
    ...
    const input = listItem.querySelector('.text_field');
